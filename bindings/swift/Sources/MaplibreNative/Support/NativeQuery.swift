...
enum NativeQuery {
  static func renderedFeatures(
    ...
    try NativeHandleFactory
      .create(nullDiagnostic: "rendered feature query returned a null result") { result in
  ...
  static func sourceFeatures(
    ...
    try NativeHandleFactory
      .create(nullDiagnostic: "source feature query returned a null result") { result in
  ...
  static func featureQueryResultGet(_ result: OpaquePointer,
  ...
  static func featureExtensions(
    ...
    try NativeHandleFactory
      .create(nullDiagnostic: "feature extension query returned a null result") { result in
  ...
  static func featureExtensionResultCopy(_ result: OpaquePointer) throws
