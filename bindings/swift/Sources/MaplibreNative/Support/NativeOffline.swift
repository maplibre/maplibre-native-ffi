...
enum NativeOffline {
  static func runAmbientCacheOperationStart(_ runtime: OpaquePointer, operation: UInt32) throws -> UInt64 {
  ...
  static func regionCreateStart(_ runtime: OpaquePointer, definition: UnsafePointer<mln_offline_region_definition>, metadata: Data) throws -> UInt64 {
  ...
  static func regionGetStart(_ runtime: OpaquePointer, regionId: Int64) throws -> UInt64 {
    try NativeMemory.withTemporary(UInt64(0)) { operationId in
  ...
  static func regionsMergeDatabaseStart(_ runtime: OpaquePointer, sideDatabasePath: String) throws -> UInt64 {
  ...
  static func regionUpdateMetadataStart(_ runtime: OpaquePointer, regionId: Int64, metadata: Data) throws -> UInt64 {
    try metadata.withUnsafeBytes { bytes in
      try NativeMemory.withTemporary(UInt64(0)) { operationId in
  ...
  static func regionGetStatusStart(_ runtime: OpaquePointer, regionId: Int64) throws -> UInt64 {
    try NativeMemory.withTemporary(UInt64(0)) { operationId in
      try checkStatus(mln_runtime_offline_region_get_status_start(runtime, regionId, operationId))
    }.value
  }

  static func regionSetObservedStart(_ runtime: OpaquePointer, regionId: Int64, observed: Bool) throws -> UInt64 {
    try NativeMemory.withTemporary(UInt64(0)) { operationId in
      try checkStatus(mln_runtime_offline_region_set_observed_start(runtime, regionId, observed, operationId))
    }.value
  }

  static func regionSetDownloadStateStart(_ runtime: OpaquePointer, regionId: Int64, state: UInt32) throws -> UInt64 {
    try NativeMemory.withTemporary(UInt64(0)) { operationId in
      try checkStatus(mln_runtime_offline_region_set_download_state_start(runtime, regionId, state, operationId))
    }.value
  }

  static func regionInvalidateStart(_ runtime: OpaquePointer, regionId: Int64) throws -> UInt64 {
    try NativeMemory.withTemporary(UInt64(0)) { operationId in
      try checkStatus(mln_runtime_offline_region_invalidate_start(runtime, regionId, operationId))
    }.value
  }

  static func regionDeleteStart(_ runtime: OpaquePointer, regionId: Int64) throws -> UInt64 {
    try NativeMemory.withTemporary(UInt64(0)) { operationId in
      try checkStatus(mln_runtime_offline_region_delete_start(runtime, regionId, operationId))
    }.value
  }

  static func regionCreateTakeResult(_ runtime: OpaquePointer, operationId: UInt64) throws -> NativeOfflineRegionInfo {
  ...
  static func regionGetTakeResult(_ runtime: OpaquePointer, operationId: UInt64) throws -> NativeOfflineRegionInfo? {
    var found = false
    let snapshot = try NativeMemory.withTemporary(Optional<OpaquePointer>.none) { snapshot in
  ...
  static func regionsListTakeResult(_ runtime: OpaquePointer, operationId: UInt64) throws -> [NativeOfflineRegionInfo] {
  ...
  static func regionsMergeDatabaseTakeResult(_ runtime: OpaquePointer, operationId: UInt64) throws -> [NativeOfflineRegionInfo] {
    let list = try NativeMemory.withTemporary(Optional<OpaquePointer>.none) { list in
  ...
  static func regionUpdateMetadataTakeResult(_ runtime: OpaquePointer, operationId: UInt64) throws -> NativeOfflineRegionInfo {
    let snapshot = try NativeMemory.withTemporary(Optional<OpaquePointer>.none) { snapshot in
  ...
  static func regionGetStatusTakeResult(_ runtime: OpaquePointer, operationId: UInt64) throws -> NativeOfflineRegionStatus {
  ...
  private static func offlineRegionSnapshotCopy(_ snapshot: OpaquePointer) throws -> NativeOfflineRegionInfo {
  ...
  private static func offlineRegionListCopy(_ list: OpaquePointer) throws -> [NativeOfflineRegionInfo] {
