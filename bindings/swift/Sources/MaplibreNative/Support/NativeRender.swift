...
enum NativeRender {
  ...
  static func metalOwnedTextureAcquireFrame(_ session: OpaquePointer) throws
  ...
  static func vulkanOwnedTextureAcquireFrame(_ session: OpaquePointer) throws
  ...
  static func openGLOwnedTextureAcquireFrame(_ session: OpaquePointer) throws
