...
pub const StyleLayerInfo = values.StyleLayerInfo;
pub const StyleLayerInfoList = values.StyleLayerInfoList;
...
pub const pluginRegisterFunctionV1 = plugin.pluginRegisterFunctionV1;
