...
class MapCameraBrowserTest {
  ...
  @Test
  fun cameraAndViewportControlsRoundTripThroughTheOwnerThread(): Promise<JsAny?> = browserTest {
    maplibreScope {
      withMap { _, map ->
  ...
  @Test
  fun projectionHelpersRoundTripSingleAndBatchedCoordinates(): Promise<JsAny?> = browserTest {
    maplibreScope {
      withMap { _, map ->
  ...
  @Test
  fun aProjectionOutlivesTheMapItWasTakenFrom(): Promise<JsAny?> = browserTest {
    maplibreScope {
      withRuntime { runtime ->
        val map =
          MapHandle.create(
  ...
  @Test
  fun aTransitionReportsItsOwnIdOnceThroughTheEventQueue(): Promise<JsAny?> = browserTest {
    maplibreScope {
      withRuntime { runtime ->
        val map =
          MapHandle.create(
  ...
  @Test
  fun aCompletedTransitionReachesItsCameraAndReportsItsIdOnce(): Promise<JsAny?> = browserTest {
    maplibreScope {
      withRuntime { runtime ->
        val map =
          MapHandle.create(
