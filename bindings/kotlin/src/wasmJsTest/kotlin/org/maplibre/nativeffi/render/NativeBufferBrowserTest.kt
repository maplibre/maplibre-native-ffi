 ...
 * binding was unreachable and a host that asked for too much lost the page's module rather than
 * catching an error. The link turns that default off; these are what say so.
 */
class NativeBufferBrowserTest {
  @Test
  fun aBufferLargerThanTheWholeHeapIsRefusedAsAnArgument(): Promise<JsAny?> = browserTest {
  ...
  @Test
  fun aBufferTheHeapCannotServeIsReportedAndLeavesTheModuleUsable(): Promise<JsAny?> = browserTest {
