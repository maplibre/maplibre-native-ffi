...
import org.maplibre.nativeffi.internal.c.mln_custom_mvt_vector_source_release_callback
import org.maplibre.nativeffi.internal.c.mln_custom_mvt_vector_source_tile_callback
...
internal class CustomMvtVectorSourceState(
  ...
  private val gate =
    CallbackGate("custom MVT vector callbacks") {
      STATES.remove(token)
      arena.close()
    }
  ...
  private val descriptor =
    NativeAccess.customMvtVectorSourceOptions(
      arena,
      options,
      fetchTileStub,
      cancelTileStub,
  ...
  private fun upcall(methodName: String): MemorySegment {
    val method =
      LOOKUP.findVirtual(
          CustomMvtVectorSourceState::class.java,
          methodName,
  ...
  private companion object {
    ...
    private val CALLBACK_DESCRIPTOR = mln_custom_mvt_vector_source_tile_callback.descriptor()
    ...
    private val RELEASE_STUB: MemorySegment =
      mln_custom_mvt_vector_source_release_callback.allocate(
