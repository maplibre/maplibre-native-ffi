 ...
 * }
 */
public class mln_rendered_feature_query_options {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MapLibreNativeC.C_POINTER.withName("layer_ids"),
        MapLibreNativeC.C_LONG.withName("layer_id_count"),
        MapLibreNativeC.C_POINTER.withName("filter")
    ).withName("mln_rendered_feature_query_options");
    ...
    private static final AddressLayout layer_ids$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("layer_ids"));
    ...
    public static final AddressLayout layer_ids$layout() {
        return layer_ids$LAYOUT;
    }

    private static final long layer_ids$OFFSET = $LAYOUT.byteOffset(groupElement("layer_ids"));
    ...
    public static MemorySegment layer_ids(MemorySegment struct) {
        return struct.get(layer_ids$LAYOUT, layer_ids$OFFSET);
    }
    ...
    public static void layer_ids(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(layer_ids$LAYOUT, layer_ids$OFFSET, fieldValue);
    }

    private static final OfLong layer_id_count$LAYOUT = (OfLong)$LAYOUT.select(groupElement("layer_id_count"));
     ...
     * }
     */
    public static final OfLong layer_id_count$layout() {
        return layer_id_count$LAYOUT;
    }

    private static final long layer_id_count$OFFSET = $LAYOUT.byteOffset(groupElement("layer_id_count"));
     ...
     * }
     */
    public static final long layer_id_count$offset() {
        return layer_id_count$OFFSET;
    }
     ...
     * }
     */
    public static long layer_id_count(MemorySegment struct) {
        return struct.get(layer_id_count$LAYOUT, layer_id_count$OFFSET);
    }
     ...
     * }
     */
    public static void layer_id_count(MemorySegment struct, long fieldValue) {
        struct.set(layer_id_count$LAYOUT, layer_id_count$OFFSET, fieldValue);
    }
