...
class MaplibreExceptionTest {
  @Test
  fun knownNativeCodesMapToStableStatusCategories(): Unit =
  ...
  @Test
  fun statusFactoryCreatesStableExceptionSubtypes(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
  ...
  @Test
  fun exceptionsCarryNativeCodeStatusAndDiagnostic(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
