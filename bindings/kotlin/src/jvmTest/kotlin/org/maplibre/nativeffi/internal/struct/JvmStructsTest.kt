...
class JvmStructsTest {
  ...
  @Test
  fun mapOptionsAndFieldMasksPreservePresentZeroValues(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val camera =
        CameraOptions().apply {
  ...
  @Test
  fun queryGeometryMaterializesEachDiscriminator(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val point =
  ...
  @Test
  fun offlineDefinitionsRoundTripBothVariants(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val tile =
  ...
  @Test
  fun styleAndImageMetadataPreserveFieldsAndLengths(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val style =
  ...
  @Test
  fun mapCreationMaterializesFastPforAndMode(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val snapshot =
  ...
  @Test
  fun resourceResponsesSnapshotOptionalFieldsAndBytes(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val response =
  ...
  @Test
  fun ownedBufferCleanupAndRuntimePayloadCopiesUseOwnedAdapterPaths(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
