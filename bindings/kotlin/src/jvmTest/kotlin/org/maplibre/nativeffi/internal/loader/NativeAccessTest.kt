...
class NativeAccessTest {
  @Test
  fun abiVersionMismatchReportsActualAndExpectedVersions(): Unit =
  ...
  @Test
  fun nativeAccessFailureIsWrappedWithJvmFlagGuidance(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val error =
  ...
  @Test
  fun missingSymbolFailureIsWrappedAsUnsatisfiedLinkError(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val error =
  ...
  @Test
  fun resourceResponseRejectsEmbeddedNulWithBindingInvalidArgument(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
  ...
  @Test
  fun resourceResponseRejectsUnknownErrorReasonWithBindingInvalidArgument(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      NativeAccess.ensureLoaded()
      val response =
        ResourceResponse(ResourceResponseStatus.ERROR).apply {
  ...
  @Test
  fun runtimeOptionsRejectEmbeddedNulWithBindingInvalidArgument(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val error =
        assertFailsWith<InvalidArgumentException> {
