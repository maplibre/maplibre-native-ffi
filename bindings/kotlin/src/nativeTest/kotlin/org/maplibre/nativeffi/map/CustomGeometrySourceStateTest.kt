...
class CustomGeometrySourceStateTest : org.maplibre.nativeffi.NativeTestBase() {
  @Test
  fun callbacksCopyTileIdsContainHostFailuresAndStopAfterClose(): Unit = runSuspendTest {
  ...
  @Test
  fun closeDuringInFlightCallbackCompletesAfterCallbackAndSuppressesLaterUpcalls(): Unit =
    runSuspendTest {
      val received = mutableListOf<CanonicalTileId>()
