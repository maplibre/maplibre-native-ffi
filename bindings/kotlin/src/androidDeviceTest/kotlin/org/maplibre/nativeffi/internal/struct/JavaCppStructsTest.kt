...
class JavaCppStructsTest {
  @Test
  fun stringViewsPreserveEmbeddedNulBytes(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      assertEquals("value\u0000suffix", JavaCppStructs.stringViewRoundTrip("value\u0000suffix"))
    }

  @Test
  fun optionDescriptorsPreservePresentZeroFields(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val camera =
        CameraOptions().apply {
  ...
  @Test
  fun queryGeometryMaterializesEveryDiscriminator(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val point =
  ...
  @Test
  fun ownedBufferIsDestroyedAfterCopyFailure(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      assertEquals(1, JavaCppStructs.ownedBufferCleanupAfterCopyFailure())
    }

  @Test
  fun offlineDefinitionsAndUnknownRuntimePayloadsCopyOwnedData(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val definition =
      ...
      val payload =
        JavaCppStructs.unknownRuntimePayload(999, byteArrayOf(1, 2, 3))
          as RuntimeEventPayload.Unknown
  ...
  @Test
  fun styleAndTextureImageReadersRejectOverflowingSizeTValues(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val style =
  ...
  @Test
  fun backendDescriptorsPreserveExtentsPointersAndBackendFields(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      ...
      val openGl =
        JavaCppStructs.openGlSnapshot(
          OpenGLBorrowedTextureDescriptor(extent, 65, 33, egl, 17, 3553)
        )
  ...
  @Test
  fun mapAndResourceDescriptorsCopyAllCreationFields(): Unit =
    org.maplibre.nativeffi.runtime.runSuspendTest {
      val map =
