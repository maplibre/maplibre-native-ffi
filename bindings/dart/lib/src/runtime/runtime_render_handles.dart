...
final class MapProjectionHandle {
  ...
  /// Converts a logical-pixel screen point to an unwrapped geographic
  /// coordinate.
  ///
...
final class VulkanOwnedTextureFrame {
  ...
  factory VulkanOwnedTextureFrame._fromNative(
    ...
    value.format,
    value.layout,
    uint64FromNative(value.image),
    uint64FromNative(value.image_view),
    value.device.address,
    owner,
  );
  ...
  final BigInt _imageBits;
  final BigInt _imageViewBits;
  final int _deviceAddress;
  final AcquiredFrame _owner;
