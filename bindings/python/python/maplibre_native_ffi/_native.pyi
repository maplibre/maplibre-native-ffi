...
class _MapProjectionHandle:
    ...
    def lat_lng_for_pixel_unwrapped(self, x: float, y: float) -> _WireDict: ...
...
class _MetalOwnedTextureFrameHandle:
    @property
    def closed(self) -> bool: ...
    def release(self, kind: int, object_bits: int, value: int) -> None: ...
