...
public sealed class CustomGeometrySourceTests
{
  ...
  public void CustomGeometryCallbacksCopyTileIdsAndSwallowExceptions()
  {
    ...
    using var state = new CustomGeometrySourceState(new CustomGeometrySourceOptions
    {
    ...
    using var throwing = new CustomGeometrySourceState(new CustomGeometrySourceOptions { FetchTile = _ => throw new InvalidOperationException("boom") });
  ...
  public void CustomGeometrySourceApisAdaptThroughNativeMap()
  {
    ...
    map.AddCustomGeometrySource("custom", new CustomGeometrySourceOptions
    {
      FetchTile = _ => { },
      CancelTile = _ => { },
      TileSize = 512,
    ...
    map.InvalidateCustomGeometrySourceRegion("custom", new LatLngBounds(new LatLng(-1, -1), new LatLng(1, 1)));
