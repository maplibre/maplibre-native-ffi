...
public sealed class GeneratedLayoutTests
{
  ...
  public void StringViewMatchesPointerAndSizeLayout()
  {
    ...
    Assert.Equal(IntPtr.Size, Marshal.OffsetOf<mln_string_view>(nameof(mln_string_view.size)).ToInt32());
  }
  ...
  public void BooleanFieldsUseOneByteNativeBoolStorage()
  {
    ...
    Assert.Equal(0, Marshal.OffsetOf<mln_json_value._data_e__Union>(
        nameof(mln_json_value._data_e__Union.bool_value)).ToInt32());
  }
