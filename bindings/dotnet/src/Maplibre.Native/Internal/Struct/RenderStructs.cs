...
internal static unsafe class RenderStructs
{
  ...
  internal static mln_vulkan_context_descriptor ToNative(VulkanContextDescriptor? context) => new()
  {
    ...
    get_instance_proc_addr = context is null ? null : (void*)context.GetInstanceProcAddr.Address,
    get_device_proc_addr = context is null ? null : (void*)context.GetDeviceProcAddr.Address,
  };
  ...
  internal static mln_opengl_owned_texture_descriptor ToNative(OpenGLOwnedTextureDescriptor descriptor)
  {
    ArgumentNullException.ThrowIfNull(descriptor);
    NativeLibraryLoader.EnsureLoaded();
  ...
  internal static mln_opengl_borrowed_texture_descriptor ToNative(OpenGLBorrowedTextureDescriptor descriptor)
  {
    ArgumentNullException.ThrowIfNull(descriptor);
    NativeLibraryLoader.EnsureLoaded();
  ...
  internal static OpenGLOwnedTextureFrame FromNative(mln_opengl_owned_texture_frame frame, FrameScope scope) =>
      new(
          scope,
          frame.generation,
          frame.width,
