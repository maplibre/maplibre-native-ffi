...
public enum SourceType : uint { Unknown = 0, Vector = 1, Raster = 2, RasterDem = 3, GeoJson = 4, Image = 5, Video = 6, Annotations = 7, CustomVector = 8 }
public enum TileScheme : uint { Xyz = 0, Tms = 1 }
public enum VectorTileEncoding : uint { Mvt = 0, Mlt = 1 }
