...
public sealed unsafe class MapProjectionHandle : IDisposable
{
  ...
  public void SetVisibleCoordinates(IReadOnlyList<LatLng> coordinates, EdgeInsets padding)
  {
    ...
    {
      NativeStatus.Check(NativeMethods.mln_map_projection_set_visible_coordinates(
          Pointer,
  ...
  public ScreenPoint PixelForLatLng(LatLng coordinate)
  {
    ...
    NativeStatus.Check(NativeMethods.mln_map_projection_pixel_for_lat_lng(Pointer, nativeCoordinate, &point));
  ...
  public LatLng LatLngForPixel(ScreenPoint point)
  {
    ...
    NativeStatus.Check(NativeMethods.mln_map_projection_lat_lng_for_pixel(Pointer, nativePoint, &coordinate));
