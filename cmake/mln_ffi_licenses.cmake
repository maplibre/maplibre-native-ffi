function(mln_ffi_add_license target source output_name)
...
function(mln_ffi_add_core_licenses target)
  mln_ffi_add_license(${target} "${MLN_FFI_SOURCE_DIR}/LICENSES.core.md"
                      "maplibre-native.md")
  mln_ffi_add_license(${target} "${MLN_FFI_SOURCE_DIR}/vendor/icu/LICENSE"
                      "icu.txt")
  mln_ffi_add_license(${target} "${MLN_FFI_SOURCE_DIR}/vendor/nunicode/LICENSE"
                      "nunicode.txt")
  if(TARGET fastpfor-lib)
    mln_ffi_add_license(
      ${target} "${MLN_FFI_SOURCE_DIR}/vendor/maplibre-tile-spec/LICENSE-APACHE"
      "fastpfor.txt")
  endif()
  if(MLN_WITH_PMTILES)
    mln_ffi_add_license(${target} "${MLN_FFI_SOURCE_DIR}/vendor/PMTiles/LICENSE"
                        "pmtiles.txt")
  endif()
endfunction()

function(mln_ffi_install_licenses target component)
  set(license_targets ${target} mln_ffi_platform_dependencies
      mln_ffi_render_dependencies)
  if(TARGET mln_ffi_platform_rust)
    list(APPEND license_targets mln_ffi_platform_rust)
  endif()
