function(mln_ffi_configure_source_linting target)
...
function(mln_ffi_configure_project_source source)
  if(MSVC)
...
function(mln_ffi_target_project_sources target)
  target_sources(${target} PRIVATE ${ARGN})
  foreach(source IN LISTS ARGN)
    mln_ffi_configure_project_source(${source})
  endforeach()
endfunction()

function(mln_ffi_target_vendor_sources target)
  target_sources(${target} PRIVATE ${ARGN})
