...
| macOS    | 🟢 ANGLE/EGL      | 🟢                | 🟢                | ❌ [#37][issue-37] |
| iOS      | -                 | -                 | ❌ [#25][issue-25] | ❌ [#37][issue-37] |
| Windows  | 🟢 WGL            | 🟢                | -                 | ❌ [#37][issue-37] |

The `macos-arm64-egl` mise variant is the macOS OpenGL/EGL backend. It uses
ANGLE with Metal as the project-managed EGL and OpenGL ES implementation.
