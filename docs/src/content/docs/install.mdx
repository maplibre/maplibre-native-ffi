...
Android platform AAR to the module that packages the APK or AAB so that the app
also carries the TLS component.

```kotlin title="build.gradle.kts"
implementation("org.maplibre.nativeffi:maplibre-native-ffi-android-platform:0.202608.0")
```
